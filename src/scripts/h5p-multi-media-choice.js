import PimenkoMultiMediaChoiceContent from './h5p-multi-media-choice-content';
 ...
 */
export default class PimenkoMultiMediaChoice extends H5P.Question {
    /**
     * @constructor
    ...
    constructor(params, contentId, extras = {}) {
        ...
        this.content = new PimenkoMultiMediaChoiceContent(
            this.params,
            contentId,
            {
                triggerResize: () => {
        ...
        this.showSolutions = (shouldRespectRequireInputFlag = false) => {
            ...
            if (this.params.behaviour.showSolutionsRequiresInput
                ...
                this.updateFeedbackContent(htmlcontent);
            }
